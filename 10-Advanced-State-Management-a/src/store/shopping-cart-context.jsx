import { createContext ,useState} from "react";//createContext bileşenler arası veri paylaşımını sağlar
import { DUMMY_PRODUCTS } from "../dummy-products";
  ...
  */
  ...
  const ctxValue={items:shoppingCart.items,addItemToCart:handleAddItemToCart,updateItemQuantity:handleUpdateCartItemQuantity}
  /**
