...
name="acquisition" olan tüm checkbox değerlerini bir dizi olarak döndürür. */
    ...
    const acquisitionChannel=fd.getAll('acquisition');//acquistion=edinim acquistionchannel=edinim kanalları
      //acquistionlar aynı name propertysine sahip olduğu için ayrı yaptık
