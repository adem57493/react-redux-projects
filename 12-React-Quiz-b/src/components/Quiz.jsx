...
//handleSkipAnswer sadece handleSelectAnswer'a bağımlıdır, çünkü activeQuestionIndex doğrudan handleSkipAnswer içinde kullanılmıyor.
    ...
    if(!shuffledAnswers.current){
        shuffledAnswers.current=[...QUESTIONS[activeQuestionIndex].answers]//başka bir soruya geçtiğimizde zamanlayıcı baştan başlamıyordu bu yüzden başka bir soruya geçtiğimizde questiontimer'ın yeniden oluşmasını sağlamalıyız ve bunları benzersiz kılmak için key propu ekleriz soru değiştiğinde değişecek olan soru indexi
