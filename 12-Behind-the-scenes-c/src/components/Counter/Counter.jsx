...
/**initialCount her değiştiğinde, setCounterChanges fonksiyonu çağrılarak geçmiş değerler
 *  dizisi (counterChanges) güncellenir.İlk değer, initialCount'ın bir obje formatında (örneğin {value: 5, id: 123}) kaydedilmesidir.
Bağımlılık Dizisi: [initialCount] sayesinde, initialCount her değiştiğinde bu useEffect çalışır. */
  useEffect(()=>{
...
/**counterChanges, sayaç değişikliklerini tutan bir dizi olarak tanımlanmıştır.
Dizi elemanları, bir value (değişim değeri) ve id (benzersiz kimlik) içerir. */

/**counterChanges dizisindeki tüm değişikliklerin toplamını hesaplar ve bu toplam güncel sayaç
 *  değerini (currentCounter) oluşturur.
reduce fonksiyonu, dizideki her value değerini toplar. */
